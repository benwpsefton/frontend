...
class __TwigTemplate_36306c5f89f44a825bfb72cdc1323f65 extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("Host name");
        ...
        yield "\"";
        // line 26
        (((( !(null === ($context["this_host"] ?? null)) && (($context["this_host"] ?? null) != "localhost")) && (($context["this_host"] ?? null) != "127.0.0.1"))) ? (yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((" data-thishost=\"" . ($context["this_host"] ?? null)) . "\""), "html", null, true)) : (yield ""));
        yield ">
        <option value=\"any\"";
        // line 27
...
";
    ...
    {
        return new Source("", "server/privileges/login_information_fields.twig", "C:\\laragon\\etc\\apps\\phpMyAdmin\\templates\\server\\privileges\\login_information_fields.twig");
    }
}
